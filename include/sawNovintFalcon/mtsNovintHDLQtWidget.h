...
#ifndef _mtsNovintHDLQtWidget_h
#define _mtsNovintHDLQtWidget_h
...
class mtsNovintHDLQtWidget: public QWidget, public mtsComponent
{
    Q_OBJECT;
    CMN_DECLARE_SERVICES(CMN_DYNAMIC_CREATION_ONEARG, CMN_LOG_ALLOW_DEFAULT);

public:
    mtsNovintHDLQtWidget(const std::string & componentName, double periodInSeconds = 50.0 * cmn_ms);
    ~mtsNovintHDLQtWidget() {}
...
CMN_DECLARE_SERVICES_INSTANTIATION(mtsNovintHDLQtWidget);

#endif // _mtsNovintHDLQtWidget_h
